...
class ConstructorPage(BasePage):
    ...
    def constructor_is_active(self):
        return self.wait_for_text_in_classname(ConstructorPageLocators.CONSTRUCTOR_LINK,
    ...
    def click_order_button(self):
        ...
        self.click_element_by_locator(ConstructorPageLocators.ORDER_BUTTON)

    @allure.step('Ждем, что появилось всплывающее окно с деталями заказа')
    def order_details_is_visible(self):
        return self.wait_for_load_element(ConstructorPageLocators.ORDER_MODAL_OPENED_LINK)
